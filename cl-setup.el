;;; cl-setup.el --- My personal extras for Common Lisp coding  -*- lexical-binding: t; -*-
...
;; Bunch of packages and personal helpers to help with Common Lisp programming

;;; Code:

(defgroup cl-setup nil
  "My personal extras for Common Lisp coding "
  :prefix "cl-extras-"
  :group 'convenience)
